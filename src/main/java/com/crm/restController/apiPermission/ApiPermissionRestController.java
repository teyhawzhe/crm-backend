...
private final String []excludePath = {"/authenticate"};
	...
	@PostMapping("/save")
	public ResponseEntity<Result<String>> save(@RequestBody @Valid ApiPermissionForm form , BindingResult br) throws Exception{
	...
	public ResponseEntity<Result<?>> findCheckApi(@Valid ApiPermissionForm form , BindingResult br){
